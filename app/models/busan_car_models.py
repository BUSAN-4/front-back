...
class BusanCarDrivingSession(BusanCarBase):
...
class BusanCarDrivingSessionInfo(BusanCarBase):
...
class BusanCarDrowsyDrive(BusanCarBase):
...
class BusanCarUserVehicle(BusanCarBase):
...
class BusanCarPlateInfo(BusanCarBase):
